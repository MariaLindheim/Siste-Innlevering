    ...
    comments: [
      {
        ...
        id: 1,
        content:
          "Hvilke blomster er best egnet for å tiltrekke bier og sommerfugler til hagen min?",
      ...
      },
      {
        ...
        id: 2,
        content:
          "Hva er de beste plantene for et skyggelagt område i hagen min? Har en tom flekk jeg vil fylle med rosa eller fiolett blomster, men det ligger i konstant skygge. Gjerne kom med mange forslag!",
        ...
        replies: [
          {
            ...
            id: 1,
            content:
              "Fra egen er erfaring syns jeg noen gode alternativer kan være bregner, impatiens, coleusblomsten og flere typer roser. Disse plantene vil blomstre og trives selv under trær eller i områder med begrenset sollys. Selv har jeg coleusblomsten i min hage :) ",
            createdAt: "25/04/2024",
            score: 4,
            replyingTo: "tore_fredriksen",
            user: {
              image: {
                png: "./images/avatars/image-ramsesmiron.png",
              },
              username: "johannesenHilde",
            },
          },
          {
            parent: 2,
            id: 1,
            content:
              "Jeg syntes Astilbe er et godt alternativ! Disse plantene produserer fluffy blomsterkolber i ulike farger, bla rosa og trives i fuktig og skyggefull jord.",
